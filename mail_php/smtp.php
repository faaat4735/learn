...
//define("SOL", "\n");
define("EOL", "\r\n");
define("SMTP_HOST", "smtp.ehaving.com");//SMTP服务器
define("SMTP_PORT", "25");//SMTP服务器端口
define("SMTP_USER", "customer_service@ehaving.com");//SMTP服务器的用户帐号
define("SMTP_PASS", "JIAjin456");//SMTP服务器的用户密码
 
 
$from = "customer_service@ehaving.com";//SMTP服务器的用户邮箱
$to = "zjf580@163.com";//发送给谁 可用逗号隔开多个邮箱
$cc = "";
$bcc = "";
 
$subject="这是一个由PHP发送的带附件";//邮件主题 很多客户端会有乱码，所以转一下码
$body = "111";//邮件内容
$smtp = new smtp(SMTP_HOST,SMTP_PORT,SMTP_USER,SMTP_PASS, true);//这里面的一个true是表示使用身份验证,否则不使用身份验证.
// $smtp->addAttachment("index.php");
